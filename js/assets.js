...
const Assets = {
  MODELS: {
    ...
    // 🏘️ 켄니 판타지 타운 키트 배경 부품 (CC0 · 외부 텍스처 Textures/colormap.png 상대 참조)
    k_wall:   'media/glb/kit/wall.glb',
    k_door:   'media/glb/kit/wall-door.glb',
    k_winS:   'media/glb/kit/wall-window-shutters.glb',
    k_winG:   'media/glb/kit/wall-window-glass.glb',
    k_gable:  'media/glb/kit/roof-gable.glb',
    k_gtop:   'media/glb/kit/roof-gable-top.glb',
    k_hgable: 'media/glb/kit/roof-high-gable.glb',
    k_hgtop:  'media/glb/kit/roof-high-gable-top.glb',
    k_tree:   'media/glb/kit/tree.glb',
    k_treeH:  'media/glb/kit/tree-high.glb',
    k_treeR:  'media/glb/kit/tree-high-round.glb',
    k_treeC:  'media/glb/kit/tree-crooked.glb',
    k_banner: 'media/glb/kit/banner-red.glb',
    k_lantern:'media/glb/kit/lantern.glb',
    k_chimney:'media/glb/kit/chimney.glb',
    k_fence:  'media/glb/kit/fence.glb',
    // 🏫 학교(랜드마크)용 — 목재 골조·아치·둥근창
    k_timberX:'media/glb/kit/wall-detail-cross.glb',
    k_timberD:'media/glb/kit/wall-detail-diagonal.glb',
    k_winRound:'media/glb/kit/wall-window-round.glb',
    k_archTop:'media/glb/kit/wall-arch-top.glb',
    k_doorRound:'media/glb/kit/wall-doorway-round.glb',
    k_hleft:  'media/glb/kit/roof-high-left.glb',
    k_hright: 'media/glb/kit/roof-high-right.glb',
  },
